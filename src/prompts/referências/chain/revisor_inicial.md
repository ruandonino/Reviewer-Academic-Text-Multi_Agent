...
4. Utilize o Checklist para guiar sua análise:
   ...
   - [ ] Uso de Convenções: O uso de abreviações e numerais segue as convenções?
</thinking_process>
...
(Nota: Repita o bloco acima para cada problema encontrado. Se não houver problemas nestes critérios, indique que a estrutura macro está correta).
