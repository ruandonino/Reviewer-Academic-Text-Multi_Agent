...
- **Sinalização e Hierarquia:** Exija padronização visual: títulos de Tabelas/Quadros acima; Figuras/Gráficos abaixo.
...
2. **Auditoria de Citações e Apoio Visual:** Há anomalias na formatação de citações (uso do et al., redundância de parênteses)? Tabelas e quadros existentes respeitam a apresentação formal exigida?
