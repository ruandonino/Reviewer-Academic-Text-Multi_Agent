...
- **Estrutura e Matriz de Literatura:** Ratifique críticas normativas sobre "Seções Órfãs". Ratifique como Semântica a exigência de uma Tabela/Quadro de síntese (Matriz de Literatura) caso múltiplos trabalhos relacionados tenham sido discutidos de forma desorganizada e a tabela seja necessária para sustentar a comparação crítica.
...
3. **Mapeamento Normativo e Semântico:** Identifique os problemas normativos apontados na formatação de citações e seções órfãs, distinguindo-os da recomendação Semântica de criação de Matriz de Literatura.
