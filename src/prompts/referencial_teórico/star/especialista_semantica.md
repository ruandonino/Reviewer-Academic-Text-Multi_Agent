...
**4. Síntese Comparativa da Literatura (Foco Semântico):**
- **Matriz de Literatura:** Se o autor revisar múltiplos trabalhos relacionados e a comparação entre autores, métodos e lacunas for necessária para sustentar a síntese crítica, exija a inclusão de uma Tabela/Quadro de síntese (Matriz de Literatura cruzando autores, métodos e lacunas) para evitar redundância de texto e permitir a comparação verificável.
...
5. **Síntese Comparativa:** Quando a narrativa discutir diversos trabalhos sem tornar comparáveis autores, métodos e lacunas, avalie se uma Matriz de Literatura é necessária para sustentar a análise crítica.
</thinking_process>
