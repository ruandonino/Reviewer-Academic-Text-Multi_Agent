...
class Settings(BaseModel):
    ...
    router_model: str = "dashscope/qwen3.6-35b-a3b"
    ...
    available_models: Dict[str, str] = {
        ...
        "dashscope/qwen-turbo-2025-04-28": "Custo BAIXO. (Input: \$0.05/1M, Output: \$0.20/1M tokens). Modelo robusto da Alibaba Cloud, eficiente para tarefas gerais e análises diversificadas com baixo custo.",
